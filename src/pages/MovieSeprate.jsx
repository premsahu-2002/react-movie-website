  ...
  if (!isLoading)
    return (
      ...
      >
        ...
        <footer
          style={{ padding: "2rem 1rem", boxShadow: " .5px -1px .5px #ddd" }}
        >
          <Button style={{ fontSize: "small" }} to=".." relative="path">
            Go Back{" "}
          </Button>
        </footer>
      </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            className="seprate-movie-btn"
            style={{ marginTop: "3rem", display: "flex", gap: "2rem" }}
          >
            <Button
              style={{ background: "transparent" }}
              onclick={() => handleWatchList(movie.imdbID)}
            >
              Add to Watchlist
            </Button>
            <Button to="/">Go to Watchlist</Button>
          </div>
        </div>
      </div>
